...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    ...
    <div class="card shadow-lg" style="max-width: 400px; width: 100%; border-radius: 15px;">
        <div class="card-body">
            <h1 class="text-center mb-4 text-dark">Daftar Masuk Admin</h1>
            
            <!-- Form Action -->
            <form action="/authenticateStaff" method="POST">
                ...
                <!-- Form Fields -->
                <div class="mb-3">
                    <label for="staff_number" class="form-label text-dark">Nombor Admin:</label>
                    <input type="text" name="admin_id" id="admin_id" class="form-control" placeholder="Masukkan nombor Admin" required>
                </div>
                <div class="mb-3">
            ...
            <br><a href="/newPasswordAdmin" class="btn btn-warning">Tukar Kata Laluan</a>
        </div>
    </div>
</div>
